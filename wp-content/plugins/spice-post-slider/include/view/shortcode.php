       ...
       <script type="text/javascript">
           jQuery(document).ready(function() {
            ...
            jQuery("#blog-carousel<?php echo intval($sps_post_id);?>").owlCarousel({
                ...
                margin:<?php if($sps_slider_type == 'banner_slider') { echo '0'; } else { echo '30'; } ?>, // margin 10px till 960 breakpoint
                autoHeight: true,
                ...
                responsive:{    
                    100:{ items:1 },
                    480:{ items:1 },
                    768:{ items:<?php if($sps_slider_type == 'banner_slider') { echo '1'; } else { echo '3'; } ?> },
                    1000:{ items:<?php if($sps_slider_type == 'banner_slider') { echo '1'; } else { echo intval($sps_item); } ?>  }            
                }
            }); 
        });
       </script>
